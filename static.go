...
var queries = map[string]string{
  ...
  "assignments_first":  "SELECT user_id, email, mobile FROM assignments JOIN users ON user_id=users.id WHERE event_id=? AND assignments.status=? ORDER BY assignments.id LIMIT 1",
